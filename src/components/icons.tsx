...
function Icon({ children, strokeWidth = 1.75, ...props }: IconProps & { children: ReactNode }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const TodayIcon = (p: IconProps) => (
  <Icon {...p}>
    ...
    <path d="M18.4 3.6a2 2 0 0 1 2.83 2.83L12.5 15.16 9 16l.84-3.5 8.56-8.9z" />
  </Icon>
)

export const EchoesIcon = (p: IconProps) => (
  <Icon {...p}>
